...
class Stock(Base):
    ...
    id_book = sq.Column(sq.Integer, sq.ForeignKey("book.id"), primary_key=True, nullable=False)
    id_shop = sq.Column(sq.Integer, sq.ForeignKey("shop.id"), primary_key=True, nullable=False)
